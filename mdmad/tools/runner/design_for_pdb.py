...
from mdmad.datasets.custom import preprocess_antibody_structure
from mdmad.models import get_model
from mdmad.modules.common.geometry import reconstruct_backbone_partially
from mdmad.modules.common.so3 import so3vec_to_rotation
from mdmad.utils.inference import RemoveNative
from mdmad.utils.protein.writers import save_pdb
from mdmad.utils.train import recursive_to
from mdmad.utils.misc import *
from mdmad.utils.data import *
from mdmad.utils.transforms import *
from mdmad.utils.inference import *
from mdmad.tools.renumber import renumber as renumber_antibody
...
def design_for_pdb(args):
    ...
    for variant in data_variants:
        ...
        save_pdb(
            data_native, os.path.join(log_dir, variant["tag"], "REF1.pdb")
        )  # w/  OpenMM minimization
...
def args_from_cmdline():
    ...
    parser.add_argument(
        "-c", "--config", type=str, default="./configs/test/codesign_single.yml"
    )
