...
from mdmad.tools.relax.openmm_relaxer import run_openmm
from mdmad.tools.relax.pyrosetta_relaxer import run_pyrosetta, run_pyrosetta_fixbb
from mdmad.tools.relax.base import TaskScanner
...
def main():
    ...
    parser.add_argument(
        "--pipeline", type=lambda s: pipeline_dict[s], default=pipeline_openmm_pyrosetta
    )
