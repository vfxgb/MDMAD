...
from mdmad.modules.common.geometry import angstrom_to_nm, pairwise_dihedrals
from mdmad.modules.common.layers import AngularEncoding
from mdmad.utils.protein.constants import BBHeavyAtom, AA
...
class PairEmbedding(nn.Module):
    ...
    def forward(
        ...
        feat_relpos = (
            self.relpos_embed(relpos + self.max_relpos) * same_chain[:, :, :, None]
        )
