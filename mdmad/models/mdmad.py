...
from mdmad.modules.common.geometry import construct_3d_basis
from mdmad.modules.common.so3 import rotation_to_so3vec
from mdmad.modules.encoders.residue import ResidueEmbedding
from mdmad.modules.encoders.pair import PairEmbedding
from mdmad.modules.diffusion.mdmad import FullDPM
from mdmad.utils.protein.constants import max_num_heavyatoms, BBHeavyAtom
...
class DiffusionAntibodyDesign(nn.Module):
    ...
    def sample(
        ...
        traj = self.diffusion.sample(
            v_0, p_0, s_0, res_feat, pair_feat, mask_generate, mask_res, **sample_opt
        )
        return traj
